...
import type { AnyListener, DrawGridEventHandlersEventMap, DrawGridEventHandlersReturnMap, EventListenerId, ListGridEventHandlersEventMap, ListGridEventHandlersReturnMap } from "./events";
...
export declare type LayoutObjectId = number | string | symbol;
...
export declare type HeaderValues = Map<any, any>;
...
export declare type SetPasteValueTestData<T> = CellAddress & {
    grid: ListGridAPI<T>;
    record: T;
    value: string;
    oldValue: any;
