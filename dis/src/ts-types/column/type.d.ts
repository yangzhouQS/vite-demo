...
export declare type SimpleBranchGraphCommand = {
    command: "branch";
    branch: string | {
        from: string;
        to: string;
...
export declare type BranchGraphCommand = SimpleBranchGraphCommand | undefined | null | SimpleBranchGraphCommand[];
export declare type ColumnTypeOption = "DEFAULT" | "default" | "NUMBER" | "number" | "CHECK" | "check" | "BUTTON" | "button" | "IMAGE" | "image" | "MULTILINETEXT" | "multilinetext" | "RADIO" | "radio";
export declare type HeaderTypeOption = "DEFAULT" | "default" | "SORT" | "sort" | "CHECK" | "check";
