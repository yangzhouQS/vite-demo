...
import type { CellRange, ColumnActionOption, ColumnIconOption, ColumnStyleOption, ColumnTypeOption, FieldDef, HeaderActionOption, HeaderStyleOption, HeaderTypeOption, LayoutObjectId, ListGridAPI, Message } from "../../ts-types";
...
export declare type OldSortOption<T> = boolean | (string & keyof T) | ((order: "asc" | "desc", col: number, grid: ListGridAPI<T>) => void);
...
export declare type HeadersDefine<T> = (GroupHeaderDefine<T> | ColumnDefine<T>)[];
...
export declare type HeaderBodyLayoutDefine<T> = {
    header: HeaderCellDefine<T>[][];
    body: CellDefine<T>[][];
};
export declare type ArrayLayoutDefine<T> = CellDefine<T>[][];
export declare type LayoutDefine<T> = HeaderBodyLayoutDefine<T> | ArrayLayoutDefine<T>;
/** @internal */
